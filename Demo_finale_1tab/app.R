...
server <- function(input, output) {
  ...
  recup1<-modelecoexServer("test",nom_modele="original",champ_vecteur=modele.original,liste_valeur=liste_values,nombre_estime=2,liste_etiquette=liste_etiquette,xstart=xstart,liste_etiquettes_tableau=liste_etiquettes_tableau,variables=c("M","S","L","Ab"),modif_param=modif_param)
  recup2<-modelecoexServer("test2",nom_modele="avec Mdelay",champ_vecteur=modele.Mdelay,liste_valeur=liste_values2,nombre_estime=3,liste_etiquette=liste_etiquette2,xstart=xstart2,liste_etiquettes_tableau=liste_etiquettes_tableau2,variables=c("Mdelay","M","S","L","Ab"),modif_param=modif_param2)
